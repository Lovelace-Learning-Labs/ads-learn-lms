...
| Week | Topic                  | T/Th classes | T/Th lab due | Sat class | Sat lab due |
| ---- | ---------------------- | ------------ | ------------ | --------- | ----------- |
| 1    | Linear data structures | 5/19 + 5/21  | 5/26         | 5/23      | 5/30        |
| 2    | Binary search trees    | 5/26 + 5/28  | 6/2          | 5/30      | 6/6         |
| 3    | Red-black trees        | 6/2 + 6/4    | 6/9          | 6/6       | 6/13        |
| 4    | Heaps                  | 6/9 + 6/11   | 6/16         | 6/13      | 6/20        |
| 5    | Tries                  | 6/16 + 6/18  | 6/23         | 6/20      | 6/27        |
| 6    | B-trees                | 6/23 + 6/25  | 6/30         | 6/27      | 7/4         |
...
* Download the current week's lab and make sure the tests run
* Ask questions or for help via Slack or email if needed
* Let your instructor know if you need to miss all or part of class, or if you need an extension on the lab
* Be on the Zoom call 5 minutes before class starts

You do not need to...

* Work on the discussion questions independently
* Work on the whiteboard problems (these are optional)
...
* We'll have time in class to work on this week's lab. You should make sure you've got the setup figured out in advance so you can make best use of class time.
